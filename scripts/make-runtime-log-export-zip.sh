...
OUTPUT_NAME="ubuntu-touch-focal-d2s-runtime-log-export.zip"
OUTPUT_DIR="$ROOT/sideload-focal"
SOURCE_ZIP="$OUTPUT_DIR/ubuntu-touch-focal-d2s-sideload.zip"
UPDATER_SHA256="0d47f97f164f18b3d6e81060680f5bfcd4ba1f59fa50f3f418cc9c36b3d36b31"
TMP="$(mktemp -d "$ROOT/workdir/runtime-log-export.XXXXXX")"
trap 'rm -rf "$TMP"' EXIT
...
install -m 0644 sideload-assets/runtime-log-export-updater-script \
